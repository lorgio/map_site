...
var slideWidth;var slideHeight;var frameHeight;var frameWidth;var scroller;var slideshow;var thumbnails;var hud;var thumbMatte=89;var pickerHeight=100;var browser;var baseURL="http://www.mac.com/1/slideshow/";var windowWidth=800;var windowHeight=800;function initSlideshow(imageStream,index,parameters){browser=new BrowserDetectLite();if(checkBrowser())
...
function initScroller(startPoint){var thumbZone=$('thumbnailPicker');var scrollbar=appendDiv(thumbZone,"scrollbar");scrollbar.style.top="84px";scrollbar.style.left="0px";scrollbar.style.width=thumbZone.getWidth()-2+"px";scrollbar.style.height="15px";var bar=appendDiv(scrollbar,"bar");bar.style.top="0px";bar.style.left="0px";bar.style.width="100%";bar.style.height="13px";var dragTool=appendDiv(scrollbar,"dragtool");dragTool.style.top="1px";dragTool.style.left="0px";dragTool.style.width="26px";dragTool.style.height="13px";dragTool=appendImage(dragTool,'http://www.mac.com/1/slideshow/images/dragger.gif',null,24,13);dragTool.setAttribute('hspace','1');var ruler=appendDiv(scrollbar,"ruler");ruler.style.top="0px";ruler.style.left="0px";scroller=new Scroller();if(startPoint!=null){scroller.jumpTo(startPoint);}
