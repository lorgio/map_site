...
var middleAligns=element.getElementsByClassName("valign-middle");for(var i=0;i<middleAligns.length;++i)
{setVerticalAlignmentAndClearClass(middleAligns[i],"middle");}
var bottomAligns=element.getElementsByClassName("valign-bottom");for(var i=0;i<bottomAligns.length;++i)
...
{var parent=$(photogrid.parentNode);var spacers=parent.getElementsByClassName('spacer');var spacer=spacers[spacers.length-1];if(initialSpacerHeight==0)
